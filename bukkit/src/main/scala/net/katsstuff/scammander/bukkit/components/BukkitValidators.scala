...
trait BukkitValidators { self: BukkitBase =>
  ...
  implicit val playerSender: UserValidator[Player] = new UserValidator[Player] {
    override def validate[F[_]: Monad: ParserError](sender: CommandSender): F[Player] = sender match {
  ...
  implicit val offlinePlayerSender: UserValidator[OfflinePlayer] = new UserValidator[OfflinePlayer] {
    override def validate[F[_]: Monad: ParserError](sender: CommandSender): F[OfflinePlayer] = sender match {
  ...
  implicit def entitySender[A <: Entity: Typeable]: UserValidator[A] = {
    ...
    new UserValidator[A] {
      override def validate[F[_]: Monad: ParserError](sender: CommandSender): F[A] = sender match {
  ...
  implicit val locationSender: UserValidator[Location] = new UserValidator[Location] {
    override def validate[F[_]: Monad: ParserError](sender: CommandSender): F[Location] = sender match {
  ...
  implicit val ipSender: UserValidator[InetAddress] = new UserValidator[InetAddress] {
    override def validate[F[_]: Monad: ParserError](sender: CommandSender): F[InetAddress] = sender match {
